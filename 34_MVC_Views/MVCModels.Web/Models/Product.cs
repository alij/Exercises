...
namespace MVCModels.Web.Models
{
    public class Product
    {
        ...
        /// <summary>
        /// Sets a derived property string for a path to the appropriate Star Image based on AverageRating
        /// </summary>
        public string StarImagePath
        {
            get
            {
                string path = "";
                if (AverageRating == 5) { path = "5-star.png"; }
